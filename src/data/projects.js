export const projects = [
  {
    slug: 'kolding',
    title: 'Kolding',
    location: 'Kolding Bibliotek',
    coordinates: [9.4776, 55.4899],
    labelOffsetSmall: { x: -120, y: -220 },
    labelOffsetLarge: { x: 110, y: 0 },
    kommune: 'Kolding Kommune',
    komkode: '0621',
    startDate: '2026-11-13',
    endDate: '2026-12-18',
    partners: 'Kolding Stadsarkiv, Kolding Ungdomsskole, TRIO og Godset',
    sponsorLogos: ['region-syddanmark', 'nordjyllands-fonden', 'william-demant-fonden'],
    description: [
  ...
  },
  {
    ...
    labelOffsetSmall: { x: 0, y: 160 },
    labelOffsetLarge: { x: 140, y: 0 },
  ...
  },
  {
    ...
    sponsorLogos: ['region-syddanmark', 'nordjyllands-fonden', 'william-demant-fonden', 'johan-hoffmann-fonden' ],
    description: [
  ...
  },
  {
    ...
    labelOffsetSmall: { x: 0, y: 100 },
    labelOffsetLarge: { x: 60, y: 0 },
    ...
    description: [
      'I en opgang på kasernen præsenteredes et værk, som udforsker, belyser og fortolker den kulturhistorie, der knytter sig til Bülows Kaserne. Udstillingen bestod af fysiske artefakter skabt af elever fra Erritsø Fællesskole, som blev omgivet af et lydværk – en sammenvævning af musikalsk improvisation udført af musikelever fra Den Kreative Skole, reallyde indspillet på kasernen af elever fra Erritsø Fællesskole og anekdoter, som beretter om livet på kasernen gennem tiden.',
      'Ved solopgang, solnedgang og hver hele time herimellem kunne man høre en kulturhonnør give genlyd i gårdrummet. Dette var en lydlig påmindelse om stedets kulturelle udvikling fra militær institution til det kulturhus, det er i dag.'
    ],
  ...
  },
  {
    ...
    labelOffsetSmall: { x: -80, y: 140 },
    labelOffsetLarge: { x: 40, y: 0 },
    ...
    description: [
      'På Kirkestrædedagen opsatte vi et udendørs og rumligt lydværk der præsenterede fortidens lydmiljø på stedet. Publikum inviteredes på en lydlig rejse tilbage til perioden i slut 1800-tallet, hvor strædet havde et helt andet liv end i dag. Lyden fra tidligere forretninger, værksteder og gadeliv klingede mellem de historiske bindingsværkshuse. Med et lydsystem bestående af 8 højttalere afdækkede lydinstallationen et område på cirka 30 meter.', 
      'Efter Kirkestrædedagen flyttedes værket indendørs i et udstillingslokale under Kirkestræde 20 for en periode, så flere borgere og besøgende kunne opleve det.'
    ],
  ...
  },
  {
    ...
    labelOffsetSmall: { x: -80, y: -160 },
    labelOffsetLarge: { x: 80, y: 0 },
    ...
    description: [
      ...
      'Ungdommen i Holbæk ligner ungdommen mange andre steder i Danmark, men den er samtidig også helt sin egen. Den har nemlig udfoldet sig på helt specifikke steder og i lokalsamfundets fællesskaber. Udstillingen i gangtunnelen nær Holbæk Station præsenterede publikum for et lydværk som fortolker ungdommens perspektiv på lokalområdet og de unges holdninger, interesser og drømme gennem skiftende tider.',
    ],
  ...
  },
  {
    ...
    description: [
      'Med elektronisk musik og reallyde fortolker værket slagteriets transformation fra åbningen af Fåborg Andels-svineslagteri i 1888 til lukningen af Tulip Slagteriet i 2016. En mangesidet historie der på alle tider synes at indeholde komplekse aspekter om alt fra arbejdsglæde og -vilkår til teknologisk udvikling, dyrevelfærd, økonomi, forurening, magt og demokrati.', 
  ...
  },
  {
    ...
    labelOffsetSmall: { x: 0, y: 180 },
    labelOffsetLarge: { x: 160, y: 0 },
