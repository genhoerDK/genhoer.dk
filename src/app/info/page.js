...
export default function Info() {
    ...
    const partners = [  'billund-kommune', 'bulows-makerspace', 'den-jyske-sparekasses-stoettefond', 'den-kreative-skole', 'esbjerg-kommune', 'ewii', 'fonden-for-sjf-bank', 'fredericia-kommune', 'faaborg-midtfyn-kommune', 'historie-haderslev', 'holbaek-stadsarkiv', 'huset-esbjerg', 
                        'johan-hoffmann-fonden', 'koege-arkiverne', 'koege-bibliotekerne', 'koege-ungdomsskole', 'kulturkasernen', 'kulturvirket-grindsted', 'mark-museet', 'museum-fredericia', 'nordea-fonden', 'nordjyllands-fonden', 'oernes-kunstfond', 'poly-udstillingsplatform', 
                        'region-syddanmark', 'spar-nord-fonden', 'sparekassen-bornholms-fond', 'trelleborg-fonden', 'vordingborg-kommune', 'william-demant-fonden'
                    ]
