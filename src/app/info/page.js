...
export default function Info() {
  ...
  return (
    <>
      {/* Contact info */}
      <div className={`fixed bottom-0 left-0 w-full h-svh bg-zinc-200 transition-transform duration-500 ease-in-out ${showContactInfo ? 'translate-y-0' : 'translate-y-full'}`}>
        {/* contact */}
      </div>
    </>
  );
